...
public class BleEncryption {
    ...
    public static final int ZHIKAI_PACKET__TYPE_RESPONSE = 0xAA;
    ...
    //获取系统状态
    public static final int ZHIKAI_PACKET_OPCODE_SYS_STUS = 0x00;
    //设置大剂量输注
    public static final int ZHIKAI_PACKET_OPCODE_SET_BLOUS = 0x12;
    //停止大剂量输注
    public static final int ZHIKAI_PACKET_OPCODE_SET_BLOUS_STOP=0x02;
    //设置泵基础率
    public static final int ZHIKAI_PACKET__OPCODE_BASAL__SET_PROFILE_BASAL_RATE = 0x03;
    //获取大剂量历史 含常规大剂量和方波大剂量
    public static final int ZHIKAI_PACKET_OPCODE_BOLUS_GET_BOLUS_HISTORY_INFORMATION = 0x04;
    //设置临时基础率 aps
    public static final int ZHIKAI_PACKET_OPCODE_BASAL_APS_SET_TEMPORARY_BASAL = 0x05;
    //设置临时基础率
    public static final int ZHIKAI_PACKET_OPCODE_BASAL_SET_TEMPORARY_BASAL = 0x06;
    //取消临时基础率
    public static final int ZHIKAI_PACKET__OPCODE_BASAL__CANCEL_TEMPORARY_BASAL = 0x7;
