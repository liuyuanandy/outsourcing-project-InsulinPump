...
import info.nightscout.pump.danars.activities.ZhiKaiBLEScanActivity
...
abstract class DanaRSActivitiesModule {
    ...
    @ContributesAndroidInjector abstract fun contributesZhiKaiBLEScanActivity(): ZhiKaiBLEScanActivity
