...
abstract class DanaRSCommModule {
    ...
    @ContributesAndroidInjector abstract fun contributesZhiKaiSystus(): ZhiKaiSystus
    @ContributesAndroidInjector abstract fun contributesZhiKaiPacketSetBlous(): ZhiKaiPacketSetBlous
    @ContributesAndroidInjector abstract fun contributesZhiKaiPacketSetBlousStop(): ZhiKaiPacketSetBlousStop
    @ContributesAndroidInjector abstract fun contributesZhiKaiPacketBasalSetProfileBasalRate(): ZhiKaiPacketBasalSetProfileBasalRate
    @ContributesAndroidInjector abstract fun contributesZhiKaiPacketBlousHistory(): ZhiKaiPacketBlousHistory
    @ContributesAndroidInjector abstract fun contributesZhiKaiPacketAPSBasalSetTemporaryBasal(): ZhiKaiPacketAPSBasalSetTemporaryBasal
    @ContributesAndroidInjector abstract fun contributesZhiKaiPacketBasalSetTemporaryBasal(): ZhiKaiPacketBasalSetTemporaryBasal
    @ContributesAndroidInjector abstract fun contributesZhiKaiPacketBasalSetCancelTemporaryBasal(): ZhiKaiPacketBasalSetCancelTemporaryBasal
