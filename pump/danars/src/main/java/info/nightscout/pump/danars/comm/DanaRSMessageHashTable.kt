...
class DanaRSMessageHashTable @Inject constructor(
    ...
    init {
        ...
        //智凯
        put(ZhiKaiSystus(injector))
        put(ZhiKaiPacketSetBlous(injector,0.0,null,null))
        put(ZhiKaiPacketSetBlousStop(injector))
        put(ZhiKaiPacketBasalSetProfileBasalRate(injector,0, arrayOf()))
        put(ZhiKaiPacketBlousHistory(injector))
        put(ZhiKaiPacketAPSBasalSetTemporaryBasal(injector,0))
        put(ZhiKaiPacketBasalSetTemporaryBasal(injector,0,0))
        put(ZhiKaiPacketBasalSetCancelTemporaryBasal(injector))
